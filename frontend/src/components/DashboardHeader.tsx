...
import { LogOut, Settings, User, TrendingUp, BarChart3, DollarSign, Sparkles, FileText, BookOpen, Menu, LineChart, Brain } from 'lucide-react';
...
export default function DashboardHeader() {
  ...
  const navItems = [
    ...
    { href: '/dashboard/ml-screening', label: 'ML Screening', icon: Brain },
